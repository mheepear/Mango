                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <?php
                         ...
                         while($res = mysqli_fetch_array($result)) {		
                            echo "<tr>";
                            echo "<td>".$res['cusid']."</td>";
                            echo "<td>".$res['cusname']."</td>";
                            echo "<td>".$res['cusaddress']."</td>";
                            echo "<td>".$res['cusphone']."</td>";	
                            echo "<td><a href=\"editcustomer.php?cusid=$res[cusid]\">Edit</a> | <a href=\"deletecustomer.php?cusid=$res[cusid]\"  onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";	
                            }
                      ?>
                    </table>
                </div>
