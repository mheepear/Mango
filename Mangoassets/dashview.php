          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><span class="glyphicon glyphicon-inbox" aria-hidden="true"></span> 33</h2>
                    <h4>Orders Pending</h4>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="well dash-box">
                    <h2><img src = truck.svg width=40 height=34 aria-hidden="true">  5</h2>
                    <h4>Truck</h4>
                  </div>
                </div>
              </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          <label>Height</label>
          <input type="text" class="form-control" name="height" placeholder="Product Height">
        </div>
        <div class="form-group">
          <label>Width</label>
          <input type="text" class="form-control" name="width" placeholder="Product Width">
        </div>
      </div>
