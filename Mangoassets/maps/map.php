        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="map.php" class="list-group-item"><span class="glyphicon glyphicon-map-marker"aria-hidden="true"></span> Navigate <span class="badge"></span></a>
            </div>
...
<div class="modal fade" id="addCustomer" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <script>
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD6UajRPkWID0Ku7jjZbHC-DpAz6MEkVBA&callback=loadMap">
